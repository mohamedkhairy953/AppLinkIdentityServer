...
public class AuthManager {
	...
	public void discradAuthState() {
		mSharedPrefRep.discardAuthState();
	}
	...
	private void setAuthData(){
		...
		if (mSharedPrefRep.getToken() != null) {
			mAuth.setAuthorizationEndpointUri(BuildConfig.LOGOUT_URI);
			discradAuthState();
			Log.d("hhhhhhh", "setAuthData: ");
			mSharedPrefRep.saveToken(null);
			mSharedPrefRep.clear();
		} else {
