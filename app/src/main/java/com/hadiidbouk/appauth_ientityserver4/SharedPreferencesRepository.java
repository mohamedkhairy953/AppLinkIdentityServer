...
public class SharedPreferencesRepository{
    ...
    public void saveToken(String token) {
        PreferenceManager.getDefaultSharedPreferences(mContext).edit().putString("token", token).apply();
    }

    public String getToken() {
        return PreferenceManager.getDefaultSharedPreferences(mContext).getString("token", null);
    }
